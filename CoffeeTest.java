...
public class CoffeeTest {
	...
	{
		assertEquals(2.0,c1.getBaseSizePrice(), .01);
		assertEquals(2.0,c2.getBaseSizePrice(), .01);
		assertEquals(2,c3.getBaseSizePrice(), .01);
		assertEquals(2,c4.getBaseSizePrice(), .01);
	}
