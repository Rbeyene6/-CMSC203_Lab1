...
public class SmoothieTest {
	...
	{
		assertEquals(2.0,s1.getBaseSizePrice(), .01);
		assertEquals(2.0,s2.getBaseSizePrice(), .01);
		assertEquals(2,s3.getBaseSizePrice(), .01);
		assertEquals(2,s4.getBaseSizePrice(), .01);
	}
	...
	public void testToString() {
		...
		assertTrue(s1.toString().contains( String.valueOf(s1.getNumberOfFruits()) ));
