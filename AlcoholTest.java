...
public class AlcoholTest {
	...
	{
		assertEquals(2.0,a1.getBaseSizePrice(), .01);
		assertEquals(2.0,a2.getBaseSizePrice(), .01);
		assertEquals(2.0,a3.getBaseSizePrice(), .01);
		assertEquals(2.0,a4.getBaseSizePrice(), .01);
	}
