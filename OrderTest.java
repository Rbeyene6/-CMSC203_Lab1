...
public class OrderTest {
	...
	public void testAddNewBeverage() throws NullPointerException   {
		...
		r1.addNewBeverage("regular Coffee", SIZE.SMALL, false,false);
	 	assertTrue(r1.getBeverage(0).getBeverageType().equals(TYPE.COFFEE));
		r1.addNewBeverage("Mohito", SIZE.SMALL); 
		assertTrue(r1.getBeverage(1).getBeverageType().equals(TYPE.ALCOHOL));
		r1.addNewBeverage("Detox", SIZE.MEDIUM,1,false); 
		assertTrue(r1.getBeverage(2).getBeverageType().equals(TYPE.SMOOTHIE));
		assertTrue(r1.getTotalItems() == 3);
		
		r2.addNewBeverage("Detox", SIZE.MEDIUM,4,true); 
		assertTrue(r2.getBeverage(0).getBeverageType().equals(TYPE.SMOOTHIE));
		r2.addNewBeverage("Mohito", SIZE.SMALL); 
		assertTrue(r2.getBeverage(1).getBeverageType().equals(TYPE.ALCOHOL));
		r2.addNewBeverage("regular Coffee", SIZE.MEDIUM, true,false);
		assertTrue(r2.getBeverage(2).getBeverageType().equals(TYPE.COFFEE));
	...
	public void testToString() {
		...
		assertTrue(r1.toString().contains( String.valueOf(r1.getOrder_Number()) ));
